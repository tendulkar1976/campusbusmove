const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StudentDashboard-CkguM1Qj.js","assets/MapView-jp-R3H_E.js","assets/MapView-Dgihpmma.css","assets/DriverDashboard-CyvVf2Yb.js"])))=>i.map(i=>d[i]);
 ...
 */function gF(t){ab(Oi),Ei(new br("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return cF(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),yn(TE,IE,t),yn(TE,IE,"esm2017")}Wn.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Wn.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};gF();const oR={apiKey:"AIzaSyBrwoWVjeHoJA_GG2ii7UPlVIMulP1yciA",authDomain:"project-8ef56e2a-0de7-492f-b49.firebaseapp.com",databaseURL:"https://project-8ef56e2a-0de7-492f-b49-default-rtdb.firebaseio.com",projectId:"project-8ef56e2a-0de7-492f-b49",storageBucket:"project-8ef56e2a-0de7-492f-b49.firebasestorage.app",messagingSenderId:"2733288149",appId:"1:2733288149:web:023f31b865312bace0505c"},Bg=gm(oR),_F=gm(oR,"secondary"),Dd=T0(Bg),HF=T0(_F),yF=$M(Bg),GF=pF(Bg),aR=F.createContext();function vF({children:t}){const[e,n]=F.useState(null),[r,i]=F.useState(null),[s,o]=F.useState(null),[a,u]=F.useState(!1),[c,d]=F.useState(!0);F.useEffect(()=>Kx(Dd,async y=>{if(d(!0),y){const T=await sb(MS(yF,"users",y.uid));if(T.exists()){const A=T.data();if(A.blocked){await Cv(Dd),n(null),i(null),o(null),u(!0),d(!1);return}i(A.role),o(A.campusId),u(!1)}else y.email==="gamethunder83@gmail.com"?(i("admin"),u(!1)):y.email==="superadmin@campusmove.com"?(i("superadmin"),u(!1)):i(null);n(y)}else n(null),i(null),o(null);d(!1)}),[]);async function f(){await Cv(Dd)}return H.jsx(aR.Provider,{value:{user:e,role:r,campusId:s,blocked:a,logout:f,loading:c},children:t})}function lR(){return F.useContext(aR)}const uR=F.createContext();function EF({children:t}){const[e,n]=F.useState(()=>{const s=localStorage.getItem("cm_theme");return s?s==="dark":window.matchMedia("(prefers-color-scheme: dark)").matches});F.useEffect(()=>{localStorage.setItem("cm_theme",e?"dark":"light"),document.documentElement.setAttribute("data-theme",e?"dark":"light")},[e]);const r=()=>n(s=>!s),i=e?{bg:"#0B0F19",bgCard:"#111827",bgCard2:"#1F2937",border:"#1F2937",borderStrong:"#374151",text:"#F9FAFB",textSub:"#E5E7EB",textMuted:"#9CA3AF",textHint:"#6B7280",accent:"#3B82F6",accentSub:"#1E3A8A",accentBorder:"#2563EB",tabActive:"#3B82F6",tabInactive:"#9CA3AF",btnText:"#F3F4F6",headerBg:"rgba(11,15,25,0.92)",inputBg:"#111827",inputBorder:"#1F2937",pill:{activeBg:"#1E3A8A",activeBorder:"#2563EB",activeText:"#93C5FD",inactiveBg:"#1F2937",inactiveBorder:"#374151",inactiveText:"#9CA3AF"}}:{bg:"#F1F5F9",bgCard:"#FFFFFF",bgCard2:"#F8F9FA",border:"#E5E7EB",borderStrong:"#D1D5DB",text:"#0F172A",textSub:"#475569",textMuted:"#6B7280",textHint:"#9CA3AF",accent:"#2563EB",accentSub:"#EFF6FF",accentBorder:"#BFDBFE",tabActive:"#2563EB",tabInactive:"#6B7280",btnText:"#475569",headerBg:"rgba(255,255,255,0.92)",inputBg:"#FFFFFF",inputBorder:"#E5E7EB",pill:{activeBg:"#EFF6FF",activeBorder:"#BFDBFE",activeText:"#1E40AF",inactiveBg:"#F8F9FA",inactiveBorder:"#E5E7EB",inactiveText:"#6B7280"}};return H.jsx(uR.Provider,{value:{dark:e,toggle:r,t:i},children:t})}function cR(){return F.useContext(uR)}function Jl({children:t,allowedRoles:e}){const{user:n,role:r,loading:i}=lR(),{t:s}=cR();return i?H.jsxs("div",{style:{minHeight:"100vh",background:s.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",transition:"background 0.25s"},children:[H.jsx("div",{style:{width:36,height:36,border:`3.5px solid ${s.border}`,borderTopColor:"#FF5A1F",borderRadius:"50%",animation:"spin 0.8s linear infinite"}}),H.jsx("style",{children:`
      ...
      `})]}):n?e&&!e.includes(r)?H.jsx(ai,{to:"/login"}):t:H.jsx(ai,{to:"/login"})}const wF=F.lazy(()=>za(()=>import("./Login-DiSruWPn.js"),[])),TF=F.lazy(()=>za(()=>import("./StudentDashboard-CkguM1Qj.js"),__vite__mapDeps([0,1,2]))),IF=F.lazy(()=>za(()=>import("./DriverDashboard-CyvVf2Yb.js"),__vite__mapDeps([3,1,2]))),SF=F.lazy(()=>za(()=>import("./AdminDashboard-CS2ECNVH.js"),[])),CF=F.lazy(()=>za(()=>import("./SuperadminDashboard-DXfL6uF-.js"),[]));function hR(){const{t}=cR();return H.jsxs("div",{style:{minHeight:"100vh",background:t.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",transition:"background 0.25s"},children:[H.jsx("div",{style:{width:36,height:36,border:`3.5px solid ${t.border}`,borderTopColor:"#FF5A1F",borderRadius:"50%",animation:"spin 0.8s linear infinite"}}),H.jsx("style",{children:`
        @keyframes spin {
          to { transform: rotate(360deg); }
        }
